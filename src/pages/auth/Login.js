                                            ...
                                            <Col md={6} className="p-5 position-relative">
                                                ...
                                                <div className="mx-auto mb-5">
                                                    <a href="/">
                                                        ...
                                                        <h3 className="d-inline align-middle ml-1 text-logo">Randeepa</h3>
                                                    </a>
                                                </div>
                                            ...
                                            <Col md={6} className="d-none d-md-inline-block">
                                                <div className="auth-page-sidebar">
                                                    ...
                                                    <div className="auth-user-testimonial">
                                                        <p className="font-size-24 font-weight-bold text-white mb-1">Farmcare Everywhere</p>
                                                        <p className="lead">No matter how the economic tides may sweep away the majority, an individual can stand clear.</p>
                                                        <p>Dr Michael Burry</p>
                                                    </div>
                                                </div>
                                            </Col>
                                        </Row>
